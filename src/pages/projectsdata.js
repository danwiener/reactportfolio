const projectsdata = [
	...
	image: "./resume.svg",
	description:
		"React.js/CSS/Bootstrap/HTML5 portfolio website built to demonstrate my projects , passions, and skills , utilizing React Components , React Routing , React States , Neuoromorphic Designs , React-Icons , extensive CSS/Bootstrap conditional styling and animations , and my body of work",
	link: "https://github.com/danwiener/GuessThePin",
    futurechanges: "Future features: advanced animations and extensive Three.js/Web GL graphics throughout for a fully immersive , interactive user-experience",
	},
    {
